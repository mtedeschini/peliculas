                                ...
                                <ul className="nav navbar-nav flex-child-menu menu-left">
                                    ...
                                    <li className="dropdown first">
                                        ...
                                        <ul className="dropdown-menu level1">
                                            <li><a href="index-2.html">Inicio 1</a></li>
                                            <li><a href="homev2.html">Inicio 2</a></li>
                                            <li><a href="homev3.html">Inicio 3</a></li>
                                        </ul>
                                    </li>
                                    <li className="dropdown first">
                                        <a className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
                                            Peliculas<i className="fa fa-angle-down" aria-hidden="true"></i>
                                        </a>
                                        <ul className="dropdown-menu level1">
                        ...
                        <div className="row ipad-width2">
                            <div className="col-md-8 col-sm-12 col-xs-12">
                                <div className="topbar-filter">
                                    <p> Encontradas <span>{props.cantidadPeliculas}</span> en total</p>
                                    <label>Sort by:</label>
                                    <select>
